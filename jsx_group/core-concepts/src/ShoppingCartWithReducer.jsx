...
const reducer = (state, action) => {
  // returns new state (based on action(optional))
  switch (action.type) {
    case "ADD_ITEM": {
      ...
      return {
        ...
        totalAmount: updatedItems.reduce(
          (acc, curr) => acc + curr.price * curr.quantity, // change acc-> total & curr -> item
          0
        ),
...
export const ShoppingCartWithReducer = () => {
  ...
  const products = [
    ...
    { id: 2, name: "Next.js Course", price: 39.99 },
    { id: 3, name: "JavaScript Bundle", price: 99.99 },
  ];
  return (
    <div>
      <h2>Products</h2>
